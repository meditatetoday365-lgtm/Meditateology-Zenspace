          ...
          {!script ? (
            ...
            <div className="animate-fade-in">
              ...
              <div className="mt-6 flex flex-col sm:flex-row justify-center gap-3">
                 <button className="bg-teal-700 text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-teal-800 shadow-md flex items-center justify-center gap-2">
                   Save to Favorites
                 </button>
                 <button 
                  onClick={handleShare}
                  className="bg-white border border-stone-200 text-stone-700 px-6 py-2.5 rounded-full text-sm font-medium hover:border-teal-500 transition-all flex items-center justify-center gap-2"
                 >
